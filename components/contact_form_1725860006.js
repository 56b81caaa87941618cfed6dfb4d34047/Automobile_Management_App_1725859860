<template>
  <main class="flex justify-center align-center p-10">
    <div class="w-fit max-w-lg p-8 bg-white shadow-lg rounded-lg">
      <div>
        <h3 class="text-black font-semibold text-xl">Get in Touch with AutoConnect</h3>
        <p class="mt-3 text-black w-fit">We're here to help with all your automotive needs</p>
      </div>
      <form @submit.prevent class="space-y-5 mt-5">
        ...
        <div>
          <label class="font-medium text-black">Vehicle Make and Model</label>
        ...
        <div>
          <label class="font-medium text-black">Year of Manufacture</label>
          <textarea
            required
